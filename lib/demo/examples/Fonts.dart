    ...
    return new Scaffold(
      ...
      bottomNavigationBar: BottomNavigationBar(
        items: <BottomNavigationBarItem>[
          BottomNavigationBarItem(icon: Icon(IconData(0xe6b9,fontFamily: 'Iconfont')), title: Text('Home')),
          BottomNavigationBarItem(icon: Icon(IconData(0xe6b5,fontFamily: 'Iconfont')), title: Text('Business')),
          BottomNavigationBarItem(icon: Icon(IconData(0xe6b3,fontFamily: 'Iconfont')), title: Text('School')),
        ],
...
class _FontsPageState extends State<FontsPage> {
  ...
  Widget build(BuildContext context) {
    ...
    var customIconsContainer = new Container(
      child: new Column(
        children: <Widget>[
          new Text(
            "Custom Icons",
          ...
          new Row(
            children: <Widget>[
              Icon(IconData(0xe6a0,fontFamily: 'Iconfont'),color: Colors.yellow,size: 60.0,),
            ],
          ),
        ],
      ),
